# Experiment Card: **Finetuning_x_shot_study** (Finetuning_mock_battery_10_shot)
...
**Experiment Name:** Finetuning_mock_battery_10_shot  
**Created:** 2026-09-16T15:35:48.813416  
...
| Key | Value |
|-----|-------|
| dataset_name | finetuning_study/mock_battery_10_shot |
| num_classes | 1 |
| class_names | ['screw'] |
| num_train_images | 10 |
| num_val_images | 10 |
