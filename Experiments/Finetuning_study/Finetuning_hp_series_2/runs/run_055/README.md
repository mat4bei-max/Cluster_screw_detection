# Experiment Card: **Finetuning_study** (Finetuning_hp_series_2)
...
**Experiment Name:** Finetuning_hp_series_2  
**Created:** 2026-09-14T13:33:01.861289  
**Git Commit ID:** main @d15d7a5  
**HPO:** No
...
| Key | Value |
|-----|-------|
| dataset_name | finetuning_study/aubaac_step_test |
| num_classes | 1 |
| class_names | ['screw'] |
| num_train_images | 10 |
| num_val_images | 15 |
